...
export class ThemeService {
    ...
    getThemeData(){
        return [
            { text: "Orange Clair", value: "orange.light", ImageSrc: "assets/icons/Component1.svg"},
            { text: "Blue Clair", value: "blue.light", ImageSrc: "assets/icons/Component2.svg" },
            { text: "Violet Clair", value: "purple.light", ImageSrc: "assets/icons/Component3.svg" },
        ]
    }
